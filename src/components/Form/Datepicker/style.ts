export const DatepickerStyle = {
  ...
  input: 'border-gray-300 focus:border-sky-400 focus:ring-sky-400',
  popup: {
    root: {
    ...
    footer: {
      ...
      button: {
        base: 'w-full rounded-lg px-5 py-2 text-center text-sm font-medium focus:ring-4 focus:ring-sky-300',
        today: 'bg-sky-500 text-white hover:bg-sky-600',
        clear:
          'border border-gray-300 focus:border-sky-400 focus:ring-sky-400 bg-white text-gray-900 hover:bg-gray-100 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600',
      },
    },
  },
  views: {
