...
export function Button({
  ...
  return (
    <button
      ...
      className={twMerge(
        bindClassNames(
          'flex items-center justify-center text-white border  hover:text-primary-700  disabled:cursor-not-allowed focus:ring-2 font-medium rounded-lg text-sm px-5 py-2.5',
          buttonColorStyle,
          className || '',
        ),
      )}
